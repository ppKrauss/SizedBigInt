...
class SizedBigInt {
   ...
   * @return {Array} the SizedBigInt's.
   */
   ...
   * @param {boolean} cycle - flagging to return to 0 after maxvalue, used by NEXT.
   * @param maxBits - integer or null, max depth or bits, used by NEXT Lexical.
   * @return {object} the SizedBigInt.
   */
   ...
   * @param {integer} bits - number of bits in the prefix.
   ...
   * @param {integer} bits - number of bits of the result.
   ...
   * @param {boolean} lexOrder - null or boolean to lexicographic order, else numeric order.
   ...
   * @param {boolean} lexOrder -  to lexicographic order, else numeric order (default).
   * @param {boolean} descOrder - to descendent order, else ascendent (default).
   */
   ...
   * @param {integer} maxBits - (positive non-zero), the maximum number of bits (depth of a complete binary tree).
   * @param {boolean} cycle - flag to use Sized Integers as cyclic group (no error on maximum value)
